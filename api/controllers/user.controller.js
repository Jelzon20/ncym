...
export const enrollUser = async (req, res, next) => {
  let notEmptyField;
  const { capacity_based, issue_based } = req.body;
  ...
  try {
    ...
    await Workshop.findByIdAndUpdate(notEmptyField, {
      $push: {
